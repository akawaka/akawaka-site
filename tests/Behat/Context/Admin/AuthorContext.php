...
use App\Context\Admin\Author\Application\Gateway\DeleteAuthor;
use App\Context\Admin\Author\Application\Gateway\FindAuthorById;
...
use App\Context\Admin\Author\Application\Gateway\BrowseAuthors;
use App\Context\Admin\Author\Application\Gateway\UpdateAuthor;
...
final class AuthorContext implements Context
{
    ...
    public function iShouldBeAbleToFindMyAuthorWithHisIdentifier()
    {
        foreach ($this->responses as $response) {
            $result = ($this->findAuthorByIdGateway)(Request::fromData($response->data()));
