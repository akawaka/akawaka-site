...
use App\Context\Admin\Article\Application\Gateway\FindArticleById;
use App\Context\Admin\Article\Application\Gateway\FindArticleById\Response;
use App\Context\Admin\Article\Application\Gateway\FindArticleBySlug;
...
use App\Context\Admin\Article\Application\Gateway\UpdateArticle;
use App\Context\Admin\Author\Application\Gateway\CreateAuthor;
use App\Context\Admin\Author\Application\Gateway\FindAuthorBySlug;
...
final class ArticleContext implements Context
{
    ...
    {
        try {
            $this->space = ($this->findSpaceByCode)(BaseFindSpaceByCode\Request::fromData([
                'code' => $space,
            ]))->data();
