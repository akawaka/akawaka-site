...
namespace Mono\Bundle\AkaBundle\Context\Security\User\Application\Operation\Read\FindByUsernameOrEmail;

use Doctrine\ORM\NoResultException;
use Mono\Bundle\AkaBundle\Context\Security\User\Domain\View\ViewInterface;
