...
namespace Mono\Bundle\AkaBundle\Context\Security\PasswordRecovery\Domain\View\DataProvider\Factory;

use Mono\Bundle\AkaBundle\Context\Security\PasswordRecovery\Domain\View\DataProvider\Model\Recovery;
use Mono\Bundle\AkaBundle\Context\Security\PasswordRecovery\Domain\View\DataProvider\Model\RecoveryInterface;
use Mono\Bundle\AkaBundle\Context\Security\PasswordRecovery\Domain\View\DataProvider\Model\User;
