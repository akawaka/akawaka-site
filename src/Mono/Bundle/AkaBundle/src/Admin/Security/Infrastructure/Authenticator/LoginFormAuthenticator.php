...
namespace Mono\Bundle\AkaBundle\Admin\Security\Infrastructure\Authenticator;

use Mono\Bundle\AkaBundle\Admin\Security\Application\Gateway\FindUserByUsernameOrEmail;
