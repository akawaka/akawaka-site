...
use Mono\Component\Page\Application\Gateway\DeletePage\Middleware\ErrorHandlerMiddleware;
use Mono\Component\Page\Application\Gateway\DeletePage\Middleware\InstrumentationMiddleware;
use Mono\Component\Page\Application\Gateway\DeletePage\Middleware\ProcessorMiddleware;
