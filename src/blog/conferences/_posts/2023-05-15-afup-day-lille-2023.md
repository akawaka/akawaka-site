...
PHP est plus épargné que Javascript ne serait-ce que par son écosystème. En moyenne, le nombre de package d'un projet PHP basé sur composer est moindre que celui d'un projet Javascript. La popularité de Javascript est aussi un facteur qui le rend plus attractif pour les attaquants.
